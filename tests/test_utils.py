...
def test_filter_vacancies_no_keywords():
    vacancies = [
        create_vacancy("Job 1", "url1", 10000, 15000, "Description 1",
                       "Requirements 1"),
        create_vacancy("Job 2", "url2", 20000, 25000, "Description 2",
                       "Requirements 2")
    ]
    keywords = []
...
def test_filter_vacancies_with_keywords_present():
    vacancies = [
        create_vacancy("Job 1", "url1", 10000, 15000, "Description keyword1",
                       "Requirements keyword2"),
        create_vacancy("Job 2", "url2", 20000, 25000, "Description keyword3",
                       "Requirements keyword4")
    ]
...
def test_filter_vacancies_with_keywords_absent():
    vacancies = [
        create_vacancy("Job 1", "url1", 10000, 15000, "Description",
                       "Requirements"),
        create_vacancy("Job 2", "url2", 20000, 25000, "Description",
                       "Requirements")
    ]
    keywords = ["keyword1", "keyword2"]
    expected_result = []
...
def test_sort_vacancies_unsorted():
    vacancies = [
        create_vacancy("Job 1", "url1", 30000, 35000, "Description",
                       "Requirements"),
        create_vacancy("Job 2", "url2", 10000, 15000, "Description",
                       "Requirements"),
        create_vacancy("Job 3", "url3", 20000, 25000, "Description",
                       "Requirements")
    ]
    expected_result = [
        create_vacancy("Job 1", "url1", 30000, 35000, "Description",
...
def test_get_top_vacancies_n_less_than_length():
    vacancies = [
        ...
        create_vacancy("Job 2", "url2", 20000, 25000, "Description",
                       "Requirements"),
        create_vacancy("Job 3", "url3", 30000, 35000, "Description",
                       "Requirements")
    ]
    n = 2
